...
-(UILabel *)ua_resizeLabelHorizontal
{
    return [self ua_resizeLabelHorizontal:0];
}

- (UILabel *)ua_resizeLabelVertical
{
    return [self ua_resizeLabelVertical:0];
}

- (UILabel *)ua_resizeLabelVertical:(CGFloat)minimumHeigh
{
...
- (UILabel *)ua_resizeLabelHorizontal:(CGFloat)minimumWidth
{
    CGRect newFrame = self.frame;
