...
- (UIImage *)ua_flip:(BOOL)isHorizontal
{
...
{
    return [self ua_imageRotatedByDegrees:[UIImage ua_radiansToDegrees:radians]];
}
/**
 *  @brief  旋转图片
 *
...
- (UIImage *)ua_imageRotatedByDegrees:(CGFloat)degrees
{
    ...
    CGAffineTransform t = CGAffineTransformMakeRotation([UIImage ua_degreesToRadians:degrees]);
    ...
    CGContextRotateCTM(bitmap, [UIImage ua_degreesToRadians:degrees]);
