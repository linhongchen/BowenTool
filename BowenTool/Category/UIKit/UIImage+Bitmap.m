...
+ (UIImage *)barCodeImageWithInfo:(NSString *)info
{
    ...
    UIImage *image =[self createNonInterpolatedUIImageFormCIImage:outputImage size:300];
    return image;
}
...
+ (UIImage *)qrCodeImageWithInfo:(NSString *)info centerImage:(UIImage *)centerImage  width:(CGFloat)width
{
    ...
    UIImage *codeImage = [UIImage createNonInterpolatedUIImageFormCIImage:qrImage size:width];
