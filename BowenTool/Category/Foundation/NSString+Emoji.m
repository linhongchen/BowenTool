...
static NSDictionary * ua_s_unicodeToCheatCodes = nil;
static NSDictionary * ua_s_cheatCodesToUnicode = nil;

+ (void)ua_initializeEmojiCheatCodes
{
    ...
    @synchronized(self)
    {
        ua_s_unicodeToCheatCodes = forwardMap;
        ua_s_cheatCodesToUnicode = [reversedMap copy];
    }
}

- (NSString *)ua_stringByReplacingEmojiCheatCodesWithUnicode
{
    if (!ua_s_cheatCodesToUnicode)
    {
        [NSString ua_initializeEmojiCheatCodes];
    }
    
    if ([self rangeOfString:@":"].location != NSNotFound)
    {
        __block NSMutableString *newText = [NSMutableString stringWithString:self];
        [ua_s_cheatCodesToUnicode enumerateKeysAndObjectsUsingBlock:^(NSString *key, id obj, BOOL *stop) {
...
- (NSString *)ua_stringByReplacingEmojiUnicodeWithCheatCodes
{
    ...
    {
        __block NSMutableString *newText = [NSMutableString stringWithString:self];
        [ua_s_unicodeToCheatCodes enumerateKeysAndObjectsUsingBlock:^(id key, id obj, BOOL *stop)
        {
